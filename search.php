      ...
      <div class="container">
        <div class="row">
            <div class="col-md-8">
                ...
                $result = mysqli_query($conn , $sql) or die (" Query Faild select author.");
                ...
                <div class="col-md-8">
                    <div class="inner-content clearfix">
                        ...
                        // substr using string limit  p1 = string p2 = starting and p3 = ending 
                        ?>
                ...
                $result1 = mysqli_query($conn, $sql1) or die("Query falied pagination");
                        ...
                        if(mysqli_num_rows($result1) > 0){
                            ...
                            if($page > 1){
                            echo '<li><a href = "index.php?aid='.$search_term.'&search='.($page - 1).'">Prev</a></li>';
                            }
