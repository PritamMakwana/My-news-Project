      ...
      <div class="container">
          <div class="row">
              ...
              <?php 
                 ...
                 $resultu = mysqli_query($conn, $test) or die ("Query Faild.". mysqli_connect_error(0));
                 if ($test) {
                    echo " <script>console.log('test is ok')</script>";
                }
                else
                {
                    echo "<script>console.log('Some test in Issue!')</script>";
                }
